...
function App() {
  return (
    <div className='min-h-screen bg-gray-50 pb-20'>
      {/* Heading on top */}
      <header className='header w-full bg-white border-b border-gray-200 py-4 px-4 mb-5 shadow-sm'>
        <div className='header-section'>
          <img src="https://www.mockforme.com/assets/images/logo.png" alt="MockForMe Logo" className="mx-auto mb-4 logo" />
          <h3 className='text-2xl md:text-2xl text-gray-900 text-center leading-tight'>
      ...
      <main className='max-w-7xl mx-auto px-4'>
        ...
        <HttpRequestTester>
          <div className='bg-white p-6 rounded-xl border border-gray-100 code-block-container'>
            <h3 className='text-sm font-bold text-black-600 uppercase tracking-wider mb-4'>Integration Code NPM</h3>
